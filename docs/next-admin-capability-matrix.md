...
- 已验收旧 React Router Admin：`info-admin-frontend-react@0b58adc4035d2b695646b0700dfc2fb707d14b57`
- 新 Next Admin 首个边界提交：`info-admin-frontend@0be6690`
- 验收实现提交：`info-admin-frontend@6d3b28f`
- 配对后端：FastAPI `info-backend@69e634b`
