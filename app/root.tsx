...
function AntDesignBoundary() {
  ...
  const { density, themeMode, themeColor } = useUiStore();
  ...
  }, [density, locale, resolvedTheme, themeColor]);
    ...
    <ConfigProvider
      ...
      theme={{
        ...
        components: {
          Layout: {
            siderBg: "#001529",
            headerBg: resolvedTheme === "dark" ? "#141414" : "#ffffff",
            bodyBg: resolvedTheme === "dark" ? "#101010" : "#f4f6f9",
          },
        },
      }}
    >
