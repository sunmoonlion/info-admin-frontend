...
ADMIN_CSR_IMAGE_REGISTRY="${ADMIN_CSR_IMAGE_REGISTRY:-harbor.sunmoonai.com:30443}"
...
push_image() {
    FULL_IMAGE_NAME="${ADMIN_CSR_IMAGE_REGISTRY}/${ADMIN_CSR_IMAGE_PROJECT}/${ADMIN_CSR_IMAGE}:${ADMIN_CSR_TAG}"
